...
// Import the module freshly for each test by re-requiring
// We test parseEnvFile behavior indirectly through loadEnvFiles
// by manipulating cwd and the filesystem.

// Since loadEnvFiles uses process.cwd(), we test the parser directly
// by creating temp .env files and calling loadEnvFiles with a controlled cwd.
