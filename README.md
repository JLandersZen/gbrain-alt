...
Every page in the brain follows the four-zone structure:
...
Build the REST API for Project Alpha. Handles authentication,
rate limiting, and the core CRUD endpoints. Using Express with
TypeScript for type safety across the stack.

---

## Relationships
- **Assigned Projects:** [Project Alpha](projects/alpha.md)
- **Related People:** [Alice Smith](people/alice.md)

---

- 2026-04-01: Started implementation, auth middleware done
- 2026-03-28: API design review with Alice — agreed on REST over GraphQL
```

**Zones:** Frontmatter (metadata + relations as slugs), compiled truth (current synthesis, rewritten as evidence changes), relationships (auto-generated clickable links), timeline (append-only evidence trail). The relationships zone is generated by gbrain from frontmatter — pages without relations use the classic two-zone format.
